  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-6 py-16">
      ...
      <section className="prose-fh mt-10 space-y-4">
        ...
        <pre className="overflow-x-auto rounded-2xl border border-line bg-paper-2 p-4 text-xs leading-relaxed"><code>{`<style>[data-firsthand="WIDGET_ID"]{min-height:476px}@media(max-width:899px){[data-firsthand="WIDGET_ID"]{min-height:720px}}@media(max-width:639px){[data-firsthand="WIDGET_ID"]{min-height:1452px}}</style>
